...
from mybot.config.schema import ModelPresetConfig
from mybot.providers.base import LLMProvider
from mybot.providers.factory import ProviderSnapshot, build_provider_snapshot
...
def normalize_preset_name(
    name: str | None, presets: dict[str, ModelPresetConfig]
) -> str:
